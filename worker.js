...
onmessage = function(e) {
    ...
    translated.size > 1 && console.log(Array.from(translated.values()).join(','));
    translated.clear()

    // const dur = performance.now() - st
    // console.log('translate done in ' + (dur / 1000).toFixed(4) + 's')

    postMessage([res.join(''), idx]);
};
